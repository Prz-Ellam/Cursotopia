    ...
    <div class="container-fluid bg-tertiary shadow-sm">
      <div class="row p-4">
        <div class="text-center col-xl-2 col-md-4 col-sm-5 col-xs-12">
          <img src="https://pbs.twimg.com/profile_images/1251100214926032896/MhdWgkD1_400x400.jpg"
          width="180" class="rounded-pill" alt="Foto de perfil">
        </div>
        <div class="col-xl-10 col-md-8 col-sm-7 col-xs-12 m-auto">
          <div class="container text-xs-center">
            <div class="row">
              <div class="col-12">
                <h3 class="fw-bold">Yan Chernikov</h3>
              </div>
            </div>
            <div class="row">
              <div class="col-12">
                <h6>thecherno@gmail.com</h6>
              </div>
            </div>
            <div class="row">
              <div class="col-12">
              ...
              <div class="col-md-4">
                <div class="ratio ratio-16x9 h-100">
                  <img
                    ...
                    class="img-cover img-fluid rounded-start" alt="Portada del curso">
                </div>
              </div>
              <div class="col-md-8">
                <div class="card-body">
        ...
        <div data-aos="fade-up">
          <div class="card mb-4 bg-light border-0">
            <div class="row g-0">
              <div class="col-md-4">
                <div class="ratio ratio-16x9 h-100">
                  <img src="https://pikuma.com/images/courses/nes.jpg" class="img-cover img-fluid rounded-start"
